                            ...
                            <div class="col-md-8 offset-2 mt-4">
                                <form action="{{Route('store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group  p-2">
                                        ...
                                        <textarea name="drescreption" id="drescreption" cols="30" rows="5" class="form-control" placeholder="Enter Product Drescreption">{{old('drescreption')}}</textarea>
                                        @error('drescreption') 
                                          <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group  p-2">
                                        ...
                                        <input type="file" class="form-control" id="image" name="image" value="{{old('image')}}" value="{{old('name')}}"/>
                                         @error('image') 
                                          <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
